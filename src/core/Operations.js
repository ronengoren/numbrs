...
const showAsStringOptionArgs = new Set([
  OperationArgs.PrintAlone,
  OperationArgs.PrintAsString,
  OperationArgs.NotParseable,
]);
...
export function newOperation(
  ...
  const newOp =
    finalOpString in Operations
      ? Operations[finalOpString].copy()
      : new Operation(
          finalOpString,
          OperationType.Constant,
          OperationSubType.Constant,
          Number(finalOpString),
        );
  if (operationArgs) {
